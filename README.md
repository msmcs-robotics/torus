...
1. On a machine used for administeringthe cluster, run the cssh script.
      ...
      1.2. You will be able to just copy the contenxt of ips.txt and past into the cssh script, but be sure to replace the numbers in the range and subnet to match your network.
